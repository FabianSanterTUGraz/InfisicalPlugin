...
- **Standardmäßig deaktiviert:** Neu angelegte Run-Configurations haben die Infisical-Injection zunächst deaktiviert; sie muss pro Run-Configuration explizit aktiviert werden (Gradle/Spring Boot: **Modify options** → Haken bei **Infisical**).
